...
After the cluster is successfully created, the kubeconfig file is saved in the `playbook/kubeconfigs/` directory as `{{ cluster_domain }}-{{ inventory_hostname }}.yaml`. Copy it to your `.kube` directory:
